...
public class Analisador {
  ...
  public static ArrayList<String> separarEmString(String input) {
    ...
    /**
     * metodo que verifica imediatamente se uma determinada palavra do array de
     * palavras possui um tipo token ou nao, Caso essa palvra possuia um tipo
     * token, entao eh atribuida um valor ou chave impar (significando que
     * podemos deixa-la assim como esta) caso contrario, valor par (significando
     * que devemos ainda trabalhar com essa palavra para identificar os tokens
     * la exestentes)
     *
     * @return estado um hashMap de palavras com os seus resectivos estdados
     * (impar ou par)
     */
    ...
    /**
     * Metodo que separa a String em um arrayList de subStrings O criterio de
     * separacao sao os operadores
     *
    ...
    /**
     * com base nas regras de todos os separadores, retorna todos separadores
     * existentes numa palavra Ex: 2+3=8 o retorno sera: + , =
     *
     * @param palavra
    ...
    /**
     * adiciona um token na lista dos tokens token Nota: Sao adicionados na
     * lista de tokens apenas aqueles elementos do hasMap que possuirem chave
     * impar, ou seja, os elementos ou palavras que ja tiverem sido
     * identificadas
     *
